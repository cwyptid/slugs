...
function loadGameAssets() {
  ...
  assets.nameBoxImage = loadImage("assets/UI/namebox.png");
  assets.nameBoxRainImage = loadImage("assets/UI/namebox_rain.png");
  assets.textButtonImage = loadImage("assets/UI/text_button.png");
  assets.otherBoxImage = loadImage("assets/UI/otherbox.png");
  assets.otherBoxRainImage = loadImage("assets/UI/otherbox_rain.png");

  // Backgrounds for different sections
  gardenAssets.section1Background = loadImage(
    "assets/environment/section1_normal.png",
  );
  gardenAssets.section2Background = loadImage(
    "assets/environment/section2_normal.png",
  );
  gardenAssets.section3Background = loadImage(
    "assets/environment/section3_normal.png",
  );
  gardenAssets.rainSprite = loadImage("assets/environment/rain.png");
  gardenAssets.rainCollisionSprite = loadImage(
    "assets/environment/rain-collision.png",
  );
  ...
  sprites.tonyAssuredRainFrames = [
    loadImage(
      "assets/sprites/tony_VN/tony_assured_rain/tony_assured_rain-1.png",
    ),
    loadImage(
      "assets/sprites/tony_VN/tony_assured_rain/tony_assured_rain-2.png",
    ),
  ];
  ...
  sprites.tonyPeacefulRainFrames = [
    loadImage(
      "assets/sprites/tony_VN/tony_peaceful_rain/tony_peaceful_rain-1.png",
    ),
    loadImage(
      "assets/sprites/tony_VN/tony_peaceful_rain/tony_peaceful_rain-2.png",
    ),
  ];
  ...
  sprites.tonySadPeacefulFrames = [
    loadImage(
      "assets/sprites/tony_VN/tony_sad_peaceful/tony_sad_peaceful-1.png",
    ),
    loadImage(
  ...
  sprites.tonyContemplativeFrames = [
    loadImage(
      "assets/sprites/tony_VN/tony_contemplative/tony_contemplative-1.png",
    ),
    loadImage(
      "assets/sprites/tony_VN/tony_contemplative/tony_contemplative-2.png",
    ),
  ];
  ...
  sprites.tonyContemplativeRainFrames = [
    loadImage(
      "assets/sprites/tony_VN/tony_contemplative_rain/tony_contemplative_rain-1.png",
    ),
    loadImage(
      "assets/sprites/tony_VN/tony_contemplative_rain/tony_contemplative_rain-2.png",
    ),
  ];
  ...
  sprites.tonyConfidentRainFrames = [
    loadImage(
      "assets/sprites/tony_VN/tony_confident_rain/tony_confident_rain-1.png",
    ),
    loadImage(
      "assets/sprites/tony_VN/tony_confident_rain/tony_confident_rain-2.png",
    ),
  ];
  ...
  sprites.tonyWistfulRainFrames = [
    loadImage(
      "assets/sprites/tony_VN/tony_wistful_rain/tony_wistful_rain-1.png",
    ),
    loadImage(
      "assets/sprites/tony_VN/tony_wistful_rain/tony_wistful_rain-2.png",
    ),
  ];
  ...
  sprites.tonyActionIdleFrames = [
    loadImage(
      "assets/sprites/tony_overworld/tony_action_idle/tony_action_idle-1.png",
    ),
    loadImage(
      "assets/sprites/tony_overworld/tony_action_idle/tony_action_idle-2.png",
    ),
  ];
  ...
  sprites.tonySurprisedFrames = [
    loadImage(
      "assets/sprites/tony_overworld/tony_surprised/tony_surprised-1.png",
    ),
    loadImage(
      "assets/sprites/tony_overworld/tony_surprised/tony_surprised-2.png",
    ),
    loadImage(
      "assets/sprites/tony_overworld/tony_surprised/tony_surprised-3.png",
    ),
  ];
  // tony_start_idle - idle looping animation (3fps)
  sprites.tonyStartIdleFrames = [
    loadImage(
      "assets/sprites/tony_overworld/tony_start_idle/tony_start_idle-1.png",
    ),
    loadImage(
      "assets/sprites/tony_overworld/tony_start_idle/tony_start_idle-2.png",
    ),
  ];
  ...
  sprites.sunflowersWateredFrames = [
    loadImage(
      "assets/sprites/plants/sunflowers_watered/sunflowers_watered-1.png",
    ),
    loadImage(
      "assets/sprites/plants/sunflowers_watered/sunflowers_watered-2.png",
    ),
  ];
  ...
  sprites.wildpatchWateredFrames = [
    loadImage(
      "assets/sprites/plants/wildpatch_watered/wildpatch_watered-1.png",
    ),
    loadImage(
      "assets/sprites/plants/wildpatch_watered/wildpatch_watered-2.png",
    ),
  ];
  // Tomatoes
  ...
  sprites.cutsceneRemoveShellAfterFrames = [
    loadImage(
      "assets/cutscenes/tony_remove_shell_after/tony_remove_shell_after-1.png",
    ),
    loadImage(
      "assets/cutscenes/tony_remove_shell_after/tony_remove_shell_after-2.png",
    ),
  ];
  ...
  sprites.cutsceneKneelingCloudsFrames = [
    loadImage(
      "assets/cutscenes/tony_kneeling_clouds/tony_kneeling_clouds-1.png",
    ),
    loadImage(
      "assets/cutscenes/tony_kneeling_clouds/tony_kneeling_clouds-2.png",
    ),
  ];
  ...
  // Rain backgrounds
  gardenAssets.section1RainBackground = loadImage(
    "assets/environment/section1_rain.png",
  );
  gardenAssets.section2RainBackground = loadImage(
    "assets/environment/section2_rain.png",
  );
  gardenAssets.section3RainBackground = loadImage(
    "assets/environment/section3_rain.png",
  );
  // Tony rain overworld sprite frames
  sprites.tonyRainFrames = [
    loadImage(
      "assets/sprites/tony_overworld/tony_idle_rain/tony_idle_rain-1.png",
    ),
    loadImage(
      "assets/sprites/tony_overworld/tony_idle_rain/tony_idle_rain-2.png",
    ),
    loadImage(
      "assets/sprites/tony_overworld/tony_idle_rain/tony_idle_rain-3.png",
    ),
  ];
}
