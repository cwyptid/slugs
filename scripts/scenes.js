...
function setupScenes() {
  ...
  scenes[1200] = {
    ...
    cutscenePreDialogueSequence: [
      ...
      assets.cutsceneRemoveShellAfter,
      assets.cutsceneEars,
    ],
    keys: [],
    nextPages: [1201],
  ...
  scenes[1354] = {
    ...
    cutsceneSprite: assets.cutsceneReturningShell,
    keys: [],
    nextPages: [1355],
  };
  ...
  scenes[1500] = {
    ...
    cutsceneSprite: assets.cutsceneKneelingShell,
    keys: [],
    nextPages: [1501],
  };
  ...
  scenes[1505] = {
    text: "…",
    cutsceneSprite: assets.cutsceneKneelingClouds,
    keys: [],
    nextPages: [1506],
  };
  ...
  scenes[1605] = {
    ...
    cutsceneSprite: assets.cutsceneRainfall,
    keys: [],
    nextPages: [1606],
  };
  ...
  scenes[2000] = {
    ...
    image: assets.contemplativeRain,
    keys: [],
    nextPages: [2017],
  };
